...
QT_MOC_LITERAL(1, 6, 12), // "redrow_field"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 11), // "int[10][10]"
QT_MOC_LITERAL(4, 32, 3), // "arr"
QT_MOC_LITERAL(5, 36, 18), // "print_to_statusbar"
QT_MOC_LITERAL(6, 55, 3), // "str"
QT_MOC_LITERAL(7, 59, 7), // "timeout"
QT_MOC_LITERAL(8, 67, 10), // "place_ship"
QT_MOC_LITERAL(9, 78, 3) // "pos"

    },
    "field\0redrow_field\0\0int[10][10]\0arr\0"
    "print_to_statusbar\0str\0timeout\0"
    "place_ship\0pos"
};
...
void field::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->redrow_field((*reinterpret_cast< int(*)[10][10]>(_a[1]))); break;
        case 1: _t->print_to_statusbar((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->place_ship((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (field::*)(int [10][10]);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&field::redrow_field)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (field::*)(const QString & , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&field::print_to_statusbar)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void field::redrow_field(int _t1[10][10])
{
...
// SIGNAL 1
void field::print_to_statusbar(const QString & _t1, int _t2)
{
